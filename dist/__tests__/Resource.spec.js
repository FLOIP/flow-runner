...
describe('Resource', () => {
    ...
    beforeEach(() => {
        baseResource = {
            content_type: __1.SupportedContentType.AUDIO,
            modes: [__1.SupportedMode.SMS],
            language_id: 'some-language-id',
            value: 'hello world!',
        };
        values = [
            Object.assign(Object.assign({}, baseResource), { content_type: __1.SupportedContentType.TEXT, value: 'My first text!' }),
            Object.assign(Object.assign({}, baseResource), { content_type: __1.SupportedContentType.TEXT }),
            Object.assign(Object.assign({}, baseResource), { content_type: __1.SupportedContentType.AUDIO, value: 'viamo://your-audio-file.wav' }),
            Object.assign(Object.assign({}, baseResource), { content_type: __1.SupportedContentType.AUDIO }),
            Object.assign(Object.assign({}, baseResource), { content_type: __1.SupportedContentType.IMAGE, value: 'viamo://your-image-file.jpg' }),
            Object.assign(Object.assign({}, baseResource), { content_type: __1.SupportedContentType.IMAGE }),
            Object.assign(Object.assign({}, baseResource), { content_type: __1.SupportedContentType.VIDEO, value: 'viamo://your-video-file.mp4' }),
            Object.assign(Object.assign({}, baseResource), { content_type: __1.SupportedContentType.VIDEO }),
        ];
    ...
    describe('getText', () => {
        ...
        it('should return text interpolated with values from context when an expression is provided', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            resource.values = [Object.assign(Object.assign({}, baseResource), { content_type: __1.SupportedContentType.TEXT, value: 'Hello @contact.name!' })];
