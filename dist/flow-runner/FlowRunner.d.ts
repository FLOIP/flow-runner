...
export declare class FlowRunner implements IFlowRunner, IFlowNavigator, IPromptBuilder {
    ...
    completeInteraction(blockInteraction: IBlockInteraction, selectedExitId: IBlockExit['uuid'], completedAt?: Date): IBlockInteraction;
