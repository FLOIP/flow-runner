...
class default_1 {
    ...
    hydrateRichCursorFrom(ctx) {
        const { cursor } = ctx;
        return [IContext_1.findInteractionWith(cursor[0], ctx), this.createPromptFrom(cursor[1])];
    }
    ...
    createBlockInteractionFor({ uuid: blockId }, flowId, originFlowId = undefined, originBlockInteractionId = undefined) {
        return {
