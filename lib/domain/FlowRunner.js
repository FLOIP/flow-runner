...
const SupportedMode_1 = tslib_1.__importDefault(require("../flow-spec/SupportedMode"));
...
class default_1 {
    ...
    hydrateRichCursorFrom(ctx) {
        const { cursor } = ctx;
        let interaction = IContext_1.findInteractionWith(cursor[0], ctx);
    ...
    createContextFor(contact, userId, flows, languageId = 'en_US') {
        return {
